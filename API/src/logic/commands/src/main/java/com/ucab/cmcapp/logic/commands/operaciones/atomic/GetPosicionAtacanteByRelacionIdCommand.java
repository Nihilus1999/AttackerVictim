...
public class GetPosicionAtacanteByRelacionIdCommand extends Command<Relacion_VA> {

    private Relacion_VA _relacion_va;
    private Historico_Usuario _result;
    private Relacion_VADao _dao;

    public GetPosicionAtacanteByRelacionIdCommand(Relacion_VA relacion_va) {
    ...
    public void execute() {
        ...
        //endregion
        try {
            _result = _dao.getPosicionAtacanteByRelacionId(_relacion_va);
