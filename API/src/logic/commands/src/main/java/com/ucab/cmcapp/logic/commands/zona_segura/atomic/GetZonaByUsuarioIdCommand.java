...
public class GetZonaByUsuarioIdCommand extends Command<Zona_Segura> {

    private Zona_Segura _zonaSegura;
    private List<Zona_Segura> _result;
    private Zona_SeguraDao _dao;

    public GetZonaByUsuarioIdCommand(Zona_Segura safeZone) {
    ...
    @Override
    public void execute() {
        _result = _dao.getZonaByUsuarioId(_zonaSegura.get_usuario());
    }
