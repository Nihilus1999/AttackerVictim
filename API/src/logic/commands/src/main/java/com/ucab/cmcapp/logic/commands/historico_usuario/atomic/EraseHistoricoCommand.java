...
public class EraseHistoricoCommand extends Command<Historico_Usuario> {

    private Historico_Usuario _Historico_Usuario;
    private Historico_UsuarioDao _dao;

    public EraseHistoricoCommand(Historico_Usuario Historico_Usuario, DBHandler handler) {
        setHandler(handler);
