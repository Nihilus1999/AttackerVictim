...
public class GetPosicionVictimaByRelacionIdCommandTest {

    private Relacion_VA relacionVA;
    private GetPosicionVictimaByRelacionIdCommand command;
    ...
    public void setUp() {
        ...
        command = new GetPosicionVictimaByRelacionIdCommand(relacionVA);
        command.setDao(dao);
    }
    ...
    public void testExecute() {
        ...
        when(dao.getPosicionVictimaByRelacionId(relacionVA)).thenReturn(result);
        ...
        verify(dao, times(0)).getPosicionVictimaByRelacionId(relacionVA);
    }
